...
label = r"C:\Users\trung\Downloads\zalo_AI\exp5\labels"

list_path = r"C:\Users\trung\Downloads\zalo_AI\exp5\labels\*.txt"
...
for path in list_path:
    ...
    for i in itertools.permutations(permute, 2):
        ...
        print(i, int(dis), int(dis_2), rate_1, rate_2)
        # print(i, int(dis), int(threshold)*2, rate_1)
        # print("----------------")
        if dis_2*1.2 < threshold  and (rate_1 > 0.2 and rate_2 > 0.2):
            print(i, int(dis_2), (threshold), rate_1)
